...
function Dashboard() {
  const [state, setState] = useState({
    ...
    {
      image: require('../images/leaf-vector.jpeg'),
      name: "",
      type: 'Advanced',
      min:25,
      kcl: 25,
    ...
    {
      image: require('../images/Cucumber-Salad.jpg'),
      name: "Cuccumber salad",
      type: 'Advanced',
      min:25,
      kcl: 25,
      category: 'Veg',
    ...
    {
      image: require('../images/TofuTikkaMasala.jpg'),
      name: "Masala tofu",
      type: 'Beginner',
      min:25,
      kcl: 25,
    ...
    {
      image: require('../images/pork-midallions.jpg'),
  ...
  return (
    <MainContainer>
      ...
      <MainHead>
        <SubDivLeft>
          <HeadImgDiv>
            <HeadImg src={require('../images/headimg.jpg')} />
          </HeadImgDiv>
          <HeadContentDiv>
            <HeadContent>Only the best recipes!</HeadContent>
      ...
      {searchValue === ""?  <ProImgDiv>
        <ProImg src={require('../images/chef-vector.png')} />
      </ProImgDiv>: null}
